...
const funnelData = [
  { step: '收银台曝光', count: 10000, rate: 100, color: '#3b82f6' },
  { step: '发起支付', count: 4000, rate: 40, color: '#8b5cf6' },
  { step: '支付成功', count: 640, rate: 16, color: '#10b981' },
];

const appFunnelData = [
  { app: 'app_01', view: 5000, initiate: 2200, success: 396, successRate: 18 },
  { app: 'app_02', view: 3000, initiate: 1050, success: 147, successRate: 14 },
  { app: 'app_03', view: 2000, initiate: 750, success: 97, successRate: 12.9 },
];
...
const countryFunnelData = [
  { country: '美国', view: 4500, initiate: 1900, success: 361, successRate: 19 },
  { country: '泰国', view: 3000, initiate: 1050, success: 147, successRate: 14 },
  { country: '印尼', view: 1500, initiate: 600, success: 72, successRate: 12 },
  { country: '英国', view: 1000, initiate: 450, success: 60, successRate: 13.3 },
];

const userTypeFunnelData = [
  { type: '新用户', view: 7000, initiate: 2500, success: 350, successRate: 14 },
  { type: '老用户', view: 3000, initiate: 1500, success: 290, successRate: 19.3 },
];

const paymentMethodFunnelData = [
  { method: '信用卡', view: 5000, initiate: 2000, success: 360, successRate: 18 },
  ...
  { method: '本地钱包', view: 500, initiate: 200, success: 16, successRate: 8 },
];

const dropOffReasons = [
  { reason: '用户主动取消', users: 1850, events: 2100, percentage: 55.0, color: '#94a3b8' },
  { reason: '余额不足', users: 650, events: 890, percentage: 19.3, color: '#f59e0b' },
  { reason: '风控拦截', users: 420, events: 450, percentage: 12.5, color: '#ef4444' },
  { reason: '网络超时', users: 280, events: 310, percentage: 8.3, color: '#f97316' },
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-rose-50 border border-rose-200 rounded-xl p-4 flex items-start gap-3">
        ...
        <div>
          <h4 className="text-sm font-semibold text-rose-800">支付成功率预警</h4>
          <p className="text-sm text-rose-600 mt-1">
            当前整体支付成功率仅为 <strong>16%</strong>，低于目标值 (25%)。建议重点排查 `app_03` 及 `$49.99` 高客单价套餐的支付链路流失原因。
          </p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <Card className="col-span-1 lg:col-span-2">
          <CardHeader>
            <CardTitle>整体支付转化漏斗</CardTitle>
            <CardDescription>基于设备/用户去重计算</CardDescription>
          </CardHeader>
          <CardContent>
          ...
          <CardContent>
            <div className="space-y-8 mt-4">
              ...
              <div className="relative pt-4 border-t border-slate-100">
                <div className="flex justify-between items-end mb-2">
                  <span className="text-sm font-medium text-slate-800">总转化率</span>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <Card>
          <CardHeader>
            <CardTitle>各 App 漏斗拆解</CardTitle>
          </CardHeader>
          <CardContent>
              ...
              <table className="w-full text-sm text-left">
                <thead className="text-xs text-slate-500 uppercase bg-slate-50">
                  <tr>
                    ...
                    <th className="px-4 py-3 text-right">发起</th>
                    <th className="px-4 py-3 text-right">成功</th>
                    <th className="px-4 py-3 text-right rounded-tr-lg">成功率</th>
                  </tr>
                </thead>
                <tbody>
        ...
        <Card>
          <CardHeader>
            <CardTitle>各国家/地区漏斗拆解</CardTitle>
          </CardHeader>
          <CardContent>
            <div className="overflow-x-auto">
              <table className="w-full text-sm text-left">
